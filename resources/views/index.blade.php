                        ...
                        <header class="header">
                            ...
                            <nav class="nav" id="nav">
                                ...
                                <div class="head__social">
                                    ...
                                    <a href="https://vm.tiktok.com/ZSJ4GBTwG/">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                             xmlns="http://www.w3.org/2000/svg">
                                            <path
            ...
            <div class="questions-accordion">
                <ul class="questions-accordion__list">
                    ...
                    <li class="questions-accordion__item">
                        ...
                        <div class="questions-accordion__body">
                            Разница в формате работы.
                            Кто-то любит чтобы был коллектив девочек, такой формат в марафоне.
                            А кому-то нравится, чтобы никто не мешал и работать с нами один на один, такой формат работы
                            в программах.
                        </div>
                    </li>
                    <li class="questions-accordion__item">
                        ...
                        <div class="questions-accordion__body">
                            Материалы мы подбираем индивидуально в течении одного дня после заполнения анкеты и оплаты
                            курса. Поэтому выбирай удобный формат занятий (программа или марафон), заполняй анкету,
                            получай доступ к содержимому формата занятий и вперед к телу своей мечты!
                        </div>
                    </li>
                    <li class="questions-accordion__item">
                        <input type="checkbox" checked>
                        ...
                        <div class="questions-accordion__body">
                            Конечно можно, выбирай удобный формат занятий (программа или марафон) заполняй анкету и на
                            основании анкеты мы подберем нагрузку необходимую для твоего тела и целей. В таком
                            индивидуальном подходе и есть главная особенность нашего проекта!
                        </div>
                    </li>
                    <li class="questions-accordion__item">
                        <input type="checkbox" checked>
                    ...
                    <li class="questions-accordion__item">
                        ...
                        <div class="questions-accordion__body">
                            Цены на сайте указаны в рублях, но записаться к нам в проект можно из любой точки мира!
                            Оплата происходит с карты согласно курсу валют на сегодняшний день. Поэтому можешь легко
                            стать частью нашей фитнес – семьи находясь в любом уголке планеты!
                        </div>
                    </li>
                    <li class="questions-accordion__item">
                        <input type="checkbox" checked>
                    ...
                    <li class="questions-accordion__item">
                        ...
                        <i class="arrow"></i>
                        <div class="questions-accordion__head">
                            Могу ли я купить ваш курс в подарок?
                        </div>
                        <div class="questions-accordion__body">
                            Конечно, необходимо выбрать удобный формат занятий (программа или марафон), заполнить анкету
                            с указанием данных человека, которому хочется сделать такой замечательный подарок!
                        </div>
                    </li>
                    <li class="questions-accordion__item">
                        <input type="checkbox" checked>
                        ...
                        <div class="questions-accordion__body">
                            Скидочные дни мы делаем, но крайне редко, один раз в несколько месяцев. Смотри рядом с
                            описанием программ, если там указан таймер, значит сейчас как акционные дни и можно успеть
                            записаться в нашу фитнес-семью со скидкой!
                        </div>
                    </li>
                </ul>
            </div>
