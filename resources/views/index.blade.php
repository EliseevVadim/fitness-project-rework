            ...
            <div class="questions-accordion">
                <ul class="questions-accordion__list">
                    ...
                    <li class="questions-accordion__item">
                        ...
                        <div class="questions-accordion__body">
                            Материалы ты получишь в течении одного дня после заполнения анкеты и оплаты курса. Поэтому
                            выбирай удобный формат занятий (программа или марафон), заполняй анкету, получай доступ к
                            содержимому программы и вперёд к телу своей мечты!<br>
                            ВАЖНО: если на почту ничего не пришло, то проверь папку "спам". Если и там ничего нет, то
                            напиши нам в чат, указанный внизу сайта. Мы решим этот вопрос.
                        </div>
                    </li>
                    <li class="questions-accordion__item">
                        <input type="checkbox" checked>
