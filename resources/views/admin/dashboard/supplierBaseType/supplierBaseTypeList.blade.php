...
@section('content')
        ...
        <div class="animated fadeIn">
            <div class="row">
                <div class="col-sm-12 col-md-12">
                    <a href="/admin/supplier-base-types/add" class="btn btn-primary btn-lg mb-3">Добавить</a>
                </div>
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header"><i class="fa fa-align-justify"></i>Типы баз</div>
                        <div class="card-body">
                            <table class="table table-responsive-sm table-bordered table-striped table-sm">
                                ...
                                <tbody>
                                @isset($supplierBaseTypes)
                                    @foreach($supplierBaseTypes as $supplierBaseType)
                                        <tr>
                                            <td>{{ $supplierBaseType->id}}</td>
                                            <td>{{ $supplierBaseType->name}}</td>
                                            <td class="btns-edit">
                                                <a href="/admin/supplier-base-types/edit/{{$supplierBaseType->id}}" class="users-btn btn btn-block btn-primary">
                                                ...
                                                <button class="users-btn btn btn-block btn-danger" onclick="deleteSupplierBaseType({{$supplierBaseType->id}})">
    ...
    <script>
        function deleteSupplierBaseType(id) {
            axios.delete('/admin/supplier-base-types/remove/' + id)
                .then(() => {
                    window.location.href = '/admin/supplier-base-types';
                })
                .catch((error) => {
                    console.log(error);
                })
