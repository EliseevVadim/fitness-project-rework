...
@section('content')
        ...
        <div class="animated fadeIn">
            <div class="row">
                <div class="col-sm-12 col-md-12">
                    <a  href="/admin/program/add" class="btn btn-primary btn-lg mb-3">Добавить</a>
                </div>
                        ...
                        <div class="card">
                            <div class="card-header program__card-header"><h3><b>{{$program->name}}</b></h3>
                                <div class="card-header-actions">
                                    <div class="btns-edit">
                                        <a href="/admin/program/edit/{{$program->id}}" class="users-btn btn btn-block btn-primary">
                                        ...
                                        <button class="users-btn btn btn-block btn-danger" onclick="deleteProgramRecord({{$program->id}})">
    ...
    <script>
        function deleteProgramRecord(id) {
            axios.delete('/admin/program/remove/' + id)
                .then(() => {
