        ...
        <div class="animated fadeIn">
            <div class="row">
                <div class="col-md-6">
                    ...
                    @endisset
                    <div class="card">
                        <div class="card-header"><strong>Создать содержимое программы</strong></div>
                        <div class="card-body">
                            <form class="form-horizontal" action="{{route('addProgramContent')}}" method="post">
                                @csrf
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input required name="google_drive_link" class="form-control" type="text" placeholder="Ссылка на google drive">
                                    </div>
                                </div>
